// Avi Karaoke Studio — v1.133 loader (web feature set through v1.133 + Windows native render/parity)
(async()=>{
  ...
  try{
    for(const n of patches) await import(`./patch-v${n}.js?v=133`);
  }catch(e){
    console.error('[v133 loader]',e);
    try{setStatus('שגיאה בטעינת עדכון v1.133: '+(e?.message||e))}catch(_){}
  }
})();