// Avi Karaoke Studio — v1.138 loader (web feature set through v1.138 + Windows native render/parity)
(async()=>{
  window.__hksLoaderVersion=138;
  ...
  try{
    for(const n of patches) await import(`./patch-v${n}.js?v=138`);
  }catch(e){
    console.error('[v138 loader]',e);
    try{setStatus('שגיאה בטעינת עדכון v1.138: '+(e?.message||e))}catch(_){}
  }
})();