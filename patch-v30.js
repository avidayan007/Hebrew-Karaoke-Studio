// Avi Karaoke Studio — v1.140 loader (web feature set through v1.140 + Windows native render/parity)
(async()=>{
  window.__hksLoaderVersion=140;
  ...
  try{
    for(const n of patches) await import(`./patch-v${n}.js?v=140`);
  }catch(e){
    console.error('[v140 loader]',e);
    try{setStatus('שגיאה בטעינת עדכון v1.140: '+(e?.message||e))}catch(_){}
  }
})();