// Avi Karaoke Studio — v1.131 loader (web feature set through v1.131 + Windows native render/parity)
(async()=>{
  ...
  try{
    for(const n of patches) await import(`./patch-v${n}.js?v=131`);
  }catch(e){
    console.error('[v131 loader]',e);
    try{setStatus('שגיאה בטעינת עדכון v1.131: '+(e?.message||e))}catch(_){}
  }
})();