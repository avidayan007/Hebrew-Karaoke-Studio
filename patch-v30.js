// Avi Karaoke Studio — v1.135 loader (web feature set through v1.135 + Windows native render/parity)
(async()=>{
  ...
  try{
    for(const n of patches) await import(`./patch-v${n}.js?v=135`);
  }catch(e){
    console.error('[v135 loader]',e);
    try{setStatus('שגיאה בטעינת עדכון v1.135: '+(e?.message||e))}catch(_){}
  }
})();