// Avi Karaoke Studio — v1.132 loader (web feature set through v1.132 + Windows native render/parity)
(async()=>{
  ...
  try{
    for(const n of patches) await import(`./patch-v${n}.js?v=132`);
  }catch(e){
    console.error('[v132 loader]',e);
    try{setStatus('שגיאה בטעינת עדכון v1.132: '+(e?.message||e))}catch(_){}
  }
})();