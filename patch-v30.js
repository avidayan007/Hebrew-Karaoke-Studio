// Avi Karaoke Studio — v1.134 loader (web feature set through v1.134 + Windows native render/parity)
(async()=>{
  ...
  try{
    for(const n of patches) await import(`./patch-v${n}.js?v=134`);
  }catch(e){
    console.error('[v134 loader]',e);
    try{setStatus('שגיאה בטעינת עדכון v1.134: '+(e?.message||e))}catch(_){}
  }
})();