// Avi Karaoke Studio — v1.136 loader (web feature set through v1.136 + Windows native render/parity)
(async()=>{
  ...
  try{
    for(const n of patches) await import(`./patch-v${n}.js?v=136`);
  }catch(e){
    console.error('[v136 loader]',e);
    try{setStatus('שגיאה בטעינת עדכון v1.136: '+(e?.message||e))}catch(_){}
  }
})();