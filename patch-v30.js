// Avi Karaoke Studio — v1.137 loader (web feature set through v1.137 + Windows native render/parity)
(async()=>{
  ...
  try{
    for(const n of patches) await import(`./patch-v${n}.js?v=137`);
  }catch(e){
    console.error('[v137 loader]',e);
    try{setStatus('שגיאה בטעינת עדכון v1.137: '+(e?.message||e))}catch(_){}
  }
})();