(()=>{
 ...
 function style(d){
   ['afdMixerPolishV43','afdMixerPolishV44','afdMixerPolishV46','afdMixerPolishV48'].forEach(id=>d.getElementById(id)?.remove());
   const s=d.createElement('style');s.id='afdMixerPolishV48';s.textContent=`
   ...
   const cross=d.getElementById('cross');if(cross&&!cross.dataset.afdMix48){cross.dataset.afdMix48='1';cross.addEventListener('input',()=>mix(d),{passive:true})}
