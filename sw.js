...
const ASSETS=['./','index.html','app.js?v=30','patch-v17.js?v=30','patch-v18.js?v=30','patch-v20.js?v=30','patch-v21.js?v=30','patch-v25.js?v=30','patch-v27.js?v=30','patch-v28.js?v=30','patch-v29.js?v=30','patch-v30.js?v=138',...PATCHES.map(n=>`patch-v${n}.js?v=138`),'manifest.webmanifest','433A5E98-4A3F-40B9-A6D0-91B22FF5B848.png'];
...
self.addEventListener('fetch',e=>{
  ...
  // FFmpeg stays outside Cache Storage so Safari can reuse its normal HTTP cache.
  ...
  // Patch/loader JS is always network-first. Old cache is fallback only.
  e.respondWith(fetch(e.request,{cache:'no-store'}).then(r=>{if(e.request.method==='GET'){const copy=r.clone();caches.open(CACHE).then(c=>c.put(e.request,copy))}return r}).catch(()=>caches.match(e.request)));
});